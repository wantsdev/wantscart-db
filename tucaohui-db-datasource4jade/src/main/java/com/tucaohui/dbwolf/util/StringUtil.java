...
public class StringUtil {
    ...
    private final static char[] c = { '1', '2', '3', '4', '5', '6', '7', '8', '9', '0', 'q', 'w',
     ...
     * {@link Object#toString}, but catches any exceptions that are thrown
     * and reports them in the returned string instead. Useful for
     ...
     * </p>
     * <p>
     * 通常搜索字符串和替换字符串是等长的，如果搜索字符串比替换字符串长，则多余的字符将被删除。
     * 如果搜索字符串比替换字符串短，则缺少的字符将被忽略。
     * 
     * <pre>
     * StringUtil.replaceChars(null, *, *)           = null
     * StringUtil.replaceChars(&quot;&quot;, *, *)             = &quot;&quot;
