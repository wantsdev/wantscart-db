...
public class TokenMgrError extends Error {
    ...
    /**
     * Indicates the reason why the exception is thrown. It will have one
     * of the above 4 values.
     */
    int errorCode;

    /**
     * Replaces unprintable characters by their escaped (or unicode
     ...
     * indicates if EOF caused the lexical error curLexState : lexical
     * state in which this error occurred errorLine : line number when the
     * error occurred errorColumn : column number when the error occurred
     ...
     * INVALID_LEXICAL_STATE are not of end-users concern, so you can
