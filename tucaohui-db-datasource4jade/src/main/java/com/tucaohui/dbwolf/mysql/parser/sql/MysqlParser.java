...
import com.tucaohui.dbwolf.parser.Parser;
...
import com.tucaohui.dbwolf.parser.expression.OrExpression;
import com.tucaohui.dbwolf.parser.expression.ParameterExpression;
import com.tucaohui.dbwolf.parser.function.Function;
import com.tucaohui.dbwolf.parser.function.TimeConverter;
import com.tucaohui.dbwolf.parser.statment.CommitStatment;
...
import com.tucaohui.dbwolf.parser.statment.PropertyStatment;
import com.tucaohui.dbwolf.parser.statment.RollbackStatment;
import com.tucaohui.dbwolf.parser.statment.SelectStatment;
import com.tucaohui.dbwolf.parser.statment.StartTansactionStatment;
...
import com.tucaohui.jade.datasource.SQLParseInfo;

public class MysqlParser implements /*@bgen(jjtree)*/MysqlParserTreeConstants,
        Parser, MysqlParserConstants {/*@bgen(jjtree)*/
     ...
     */
    public static void main(String args[]) throws com.tucaohui.dbwolf.parser.ParseException {
        ...
        SQLParseInfo parseInfo = SQLParseInfo
                .getParseInfo("SELECT id,page_id,operator,operation,op_time,score,is_admin FROM tree_score_history WHERE page_id=? and operation != 3 order by id desc limit ?,? ");
    ...
    public Statment doParse() throws com.tucaohui.dbwolf.parser.ParseException {
        try {
            ...
            throw new com.tucaohui.dbwolf.parser.ParseException(e);
        }
    }
    ...
    */
                ...
                switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                    ...
                    case 142:
                        ...
                        if (expression instanceof ColumnExpression
                                && !(otherExpression instanceof ColumnExpression)) {
                            ...
                            ComparisonExpression comparativeExpression = new ComparisonExpression();
                            comparativeExpression.setComparison(Comparative
                                    .exchangeComparison(function));
    ...
    final public Expression SQLInClause(Expression inputExpression) throws ParseException {
        ...
        if (list.size() == 1) {
            ...
            comparativeExpression.setComparison(not ? Comparative.NotEquivalent
    ...
    /**
     * void SQLExpotentExpression() #void: {} { SQLUnaryExpression() //(
     * "**" SQLUnaryExpression())* }
     **/
                                        ...
                                        if (jj_3R_100()) {
                                            ...
                                            if (jj_3R_101()) {
                                                ...
                                                if (jj_3R_102()) {
                                                    ...
                                                    jj_semLA = getFunction(getToken(1).image
                                                            .toUpperCase()) != null;
    ...
    private static void jj_la1_init_0() {
        jj_la1_0 = new int[] { 0x0, 0x100000, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x20000, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x80000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x200, 0x200,
                0x0, 0x4000000, 0x80000000, 0x0, 0x0, 0x40, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x200040, 0x200040, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x200, 0x200, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x200, 0x0, 0x0, 0x200, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x80, 0x0, 0x0, 0x0, 0x400, 0x0, 0x140, 0x140, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x6000, 0x0, 0x0, 0x0, 0x0, 0x200040, 0x200040, 0x0,
                0x0, 0x0, 0x0, 0x48000, 0x0, 0x0, 0x48800, 0x0, 0x0, 0x0, 0x80000000, 0x0, 0x0,
                0x0, 0x0, };
    }

    private static void jj_la1_init_1() {
        jj_la1_1 = new int[] { 0x0, 0x3000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x1000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4, 0x3000, 0x0, 0x200,
                0x0, 0x20000000, 0x0, 0x0, 0x0, 0x2, 0x0, 0x800000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4, 0x0, 0x10, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x30800, 0x0, 0x0, 0x20000, 0x0, 0x800, 0x800, 0x20000, 0x30800, 0x30800, 0x0, 0x0,
                0x0, 0x0, 0x20000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x20, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x800000, 0x800000, 0x0, 0x840180, 0x0, 0x0, 0x0, 0x800000, 0x0,
                0x800000, 0x800000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1000000, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x1000, 0x0, 0x0, 0xc00c001, 0x0, 0x0, 0xc00c001, 0x0,
                0x10000000, 0x40000000, 0x0, 0x0, 0x0, 0x0, 0x0, };
    }

    private static void jj_la1_init_2() {
        jj_la1_2 = new int[] { 0x100, 0x300600, 0x0, 0x0, 0x0, 0x0, 0x0, 0x80, 0x80, 0x0, 0x0, 0x0,
                0x0, 0xc0000000, 0x0, 0x0, 0x8000000, 0x0, 0x0, 0x200, 0x4000, 0x0, 0x8000000, 0x0,
                0x0, 0x0, 0x0, 0x800200, 0x0, 0x800600, 0x0, 0x0, 0x20000018, 0x0, 0x0, 0x0, 0x0,
                0x4000, 0x0, 0x0, 0x0, 0x0, 0x4000000, 0x0, 0x20000018, 0x40000, 0x200, 0x0, 0x0,
                0x8000000, 0x0, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x1000, 0x0, 0x5000, 0x400000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x200, 0x0, 0x0, 0x0, 0x0, 0xc000, 0xc000, 0x0, 0x0, 0x0, 0x0, 0xc0800000,
                0x0, 0x4000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4000, 0x0, 0x0, 0x3000040, 0x0, 0x0,
                0x3000040, 0x0, 0x0, 0x0, 0x20, 0x0, 0x0, 0x0, 0x0, };
    }

    private static void jj_la1_init_3() {
        jj_la1_3 = new int[] { 0x0, 0x8c00, 0x3000, 0x0, 0x3000, 0x0, 0xc8000000, 0x0, 0x0,
                0xf0000, 0xc8000000, 0x0, 0x0, 0xc8200000, 0x8104000, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x880003f8, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x880003f8, 0x0, 0x0, 0x0, 0x8000000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x200000, 0x200000, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x8000000, 0x0, 0x2, 0x2000, 0x0, 0x2, 0x0,
                0x0, 0x0, 0x2, 0x2, 0x2, 0x0, 0x0, 0x8000000, 0x880003f8, 0x0, 0x0, 0x0, 0x8000000,
                0x0, 0x8000000, 0x0, 0x0, 0x8000000, 0x8000000, 0x0, 0x8000000, 0x8000000, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x3f8, 0x0, 0x40600004, 0x0, 0x880003f8, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x80003f8, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x8000000, 0x8000000,
                0x8000000, 0x400000, };
    }

    private static void jj_la1_init_4() {
        jj_la1_4 = new int[] { 0x0, 0x4, 0x0, 0x8, 0x0, 0x20, 0x1, 0x40, 0x40, 0x0, 0x0, 0x80,
                0x100, 0x0, 0x0, 0x8, 0x0, 0x8, 0x8, 0x4, 0x5, 0x8, 0x0, 0x0, 0x0, 0x0, 0x0, 0x4,
                0x0, 0x4, 0x8, 0x8, 0x0, 0x8, 0x0, 0x80, 0x80, 0x1, 0x7f00, 0x80, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x4, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2, 0x2, 0x8, 0x0, 0x8000, 0x8000,
                0x10000, 0x20000, 0x40000, 0x80000, 0x100000, 0x600000, 0x600000, 0x800000, 0x8,
                0x8, 0x1000000, 0x100, 0x0, 0x0, 0x8, 0xc000000, 0x0, 0x4000000, 0x0, 0x0,
                0x8000000, 0x8000000, 0x4000000, 0xc000000, 0xc000000, 0x4, 0x0, 0x0, 0x5, 0x0,
                0x0, 0x4, 0x1, 0x8, 0x1, 0x8, 0x0, 0x1, 0x1, 0x8, 0x1, 0x1, 0x10000000, 0x0, 0x0,
                0x0, 0x0, 0x7f00, 0x7f00, 0x8, 0x0, 0x0, 0x0, 0x4, 0x0, 0x0, 0xe0000000,
                0xe0000000, 0x1000000, 0x1000000, 0x60000000, 0x60000000, 0x0, 0x0, 0x2, 0x4, 0x1,
                0x80, 0x80, 0x0, 0x0, 0x1000000, 0x0, 0x8, 0x4, 0x0, 0x8, 0x4, 0x0, 0x8, 0x0, 0x0,
                0x0, 0x1, 0x1, 0x0, 0x0, };
    }

    private static void jj_la1_init_5() {
        jj_la1_5 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x3, 0x3, 0xe, 0xe, 0x10, 0x10, 0x0, 0x10, 0x0, 0x0, 0x10,
