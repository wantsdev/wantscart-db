 ...
 * 
 * You can modify this class to customize your error reporting mechanisms
...
public class ParseException extends Exception {
     ...
     * the generated parser. Calling this constructor generates a new
     * object of this type with the fields "currentToken",
     ...
     * you can think of. Constructing the exception in this manner makes
     * the exception behave in the normal way - i.e., as documented in the
     * class "Throwable". The fields "errorToken",
     * "expectedTokenSequences", and "tokenImage" do not contain relevant
     * information. The JavaCC generated code does not use these
     * constructors.
     */
     ...
     * object has been created due to a parse error, the token followng
     ...
     * in the generated ...Constants interface.
     */
     ...
     * error message and returns it. If this object has been created due to
     * a parse error, and you do not catch it (it gets thrown from the
