...
import com.tucaohui.dbwolf.sqljep.function.Add;
import com.tucaohui.dbwolf.sqljep.function.Between;
import com.tucaohui.dbwolf.sqljep.function.ComparativeEQ;
import com.tucaohui.dbwolf.sqljep.function.ComparativeGE;
import com.tucaohui.dbwolf.sqljep.function.ComparativeGT;
import com.tucaohui.dbwolf.sqljep.function.ComparativeIsNotNull;
import com.tucaohui.dbwolf.sqljep.function.ComparativeIsNull;
import com.tucaohui.dbwolf.sqljep.function.ComparativeLE;
import com.tucaohui.dbwolf.sqljep.function.ComparativeLT;
import com.tucaohui.dbwolf.sqljep.function.ComparativeNE;
import com.tucaohui.dbwolf.sqljep.function.Concat;
import com.tucaohui.dbwolf.sqljep.function.Divide;
import com.tucaohui.dbwolf.sqljep.function.In;
import com.tucaohui.dbwolf.sqljep.function.Like;
import com.tucaohui.dbwolf.sqljep.function.LogicalAND;
import com.tucaohui.dbwolf.sqljep.function.LogicalNOT;
import com.tucaohui.dbwolf.sqljep.function.LogicalOR;
import com.tucaohui.dbwolf.sqljep.function.Modulus;
import com.tucaohui.dbwolf.sqljep.function.Multiply;
import com.tucaohui.dbwolf.sqljep.function.NotLike;
import com.tucaohui.dbwolf.sqljep.function.PostfixCommandI;
import com.tucaohui.dbwolf.sqljep.function.Subtract;
import com.tucaohui.dbwolf.sqljep.function.UMinus;
...
public abstract class Parser/*@bgen(jjtree)*/implements ParserTreeConstants, ParserConstants {/*@bgen(jjtree)*/
    ...
    public Node parseStream(java.io.Reader stream) throws ParseException {
        ReInit(stream);
    ...
    /**
     * Translate all escape sequences to characters. Inspired by Rob
    ...
    final public void UnaryExpressionNotPlusMinus() throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            default:
                jj_la1[15] = jj_gen;
                if (jj_2_3(1)) {
                    if (getToken(1).kind == IDENTIFIER && containsKey(getToken(1).image)) {
                        Function();
                    } else {
                        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                            case IDENTIFIER:
    ...
    final private boolean jj_3_3() {
        ...
        xsp = jj_scanpos;
        lookingAhead = true;
        jj_semLA = getToken(1).kind == IDENTIFIER && containsKey(getToken(1).image);
        lookingAhead = false;
    ...
    private static void jj_la1_0() {
        jj_la1_0 = new int[] { 0x1, 0x100000, 0x80000, 0x48000, 0x48000, 0x36000, 0x36000,
                0xfc00000, 0xfc00000, 0x1c0, 0x1c0, 0x1e00, 0x1e00, 0x200180, 0x0, 0xf0000000, 0x0,
                0x0, 0x0, 0xf0000000, };
    }

    private static void jj_la1_1() {
        jj_la1_1 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x10, 0xa, 0x100, 0x400, 0x400, 0xa, };
    }
