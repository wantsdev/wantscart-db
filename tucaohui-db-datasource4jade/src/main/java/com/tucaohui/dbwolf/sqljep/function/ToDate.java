...
import com.tucaohui.dbwolf.sqljep.BaseJEP;
...
public class ToDate extends PostfixCommand {
    ...
    public static java.util.Date to_date(Comparable<?> param1, Comparable<?> param2)
        ...
        if (!(param1 instanceof String) || !(param2 instanceof String)) {
            throw new ParseException(WRONG_TYPE + "  to_date(" + param1.getClass() + ","
                    + param2.getClass() + ")");
        }
        try {
