...
/**
 * This class is used only for IN (exp,exp,...) predicate. All children of
 * node with type ASTArray are items of an array.
 * 
 * @see com.tucaohui.dbwolf.sqljep.function.In
 */
