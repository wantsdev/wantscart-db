...
package com.tucaohui.dbwolf.sqljep;
...
import com.tucaohui.dbwolf.sqljep.function.Comparative;
import com.tucaohui.dbwolf.sqljep.function.ComparativeBaseList;
import com.tucaohui.dbwolf.sqljep.function.PostfixCommand;
import com.tucaohui.dbwolf.sqljep.function.PostfixCommandI;
import com.tucaohui.dbwolf.sqljep.variable.Variable;
import com.tucaohui.dbwolf.util.StaticString;
import com.tucaohui.dbwolf.util.ThreadLocalMap;
...
public abstract class BaseJEP implements ParserVisitor {
     ...
     * 
     * @throws ParseException If there are errors
    ...
    final public void parseExpression(Map<String, Integer> columnMapping,
        ...
        try {
            ...
            throw new ParseException(toString(), e);
        }
     ...
     * {@link JepRuntime#stack} for evaluation.
     * <p>
