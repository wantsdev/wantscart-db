...
public class AddTime extends PostfixCommand {
    ...
    /**
     * Calculates the result of applying the "+" operator to the arguments
     * from the stack and pushes it back on the stack.
     */
    ...
    public static java.util.Date addTime(Comparable<?> param1, Comparable<?> param2, Calendar cal)
        ...
        if ((param1 instanceof Time || param1 instanceof Timestamp) && param2 instanceof Time) {
            ...
            return (param1 instanceof Time) ? new Time(cal.getTimeInMillis()) : new Timestamp(
                    cal.getTimeInMillis());
        } else {
            throw new ParseException(WRONG_TYPE + "  addtime(" + param1.getClass() + ","
                    + param2.getClass() + ")");
        }
    }
