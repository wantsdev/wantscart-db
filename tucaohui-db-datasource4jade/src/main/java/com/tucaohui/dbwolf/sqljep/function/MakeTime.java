...
public class MakeTime extends PostfixCommand {
    ...
    public static Time makeTime(Comparable<?> param1, Comparable<?> param2, Comparable<?> param3,
            Calendar cal) throws ParseException {
        ...
        throw new ParseException(WRONG_TYPE + " maketime(" + param1.getClass() + ","
                + param2.getClass() + ")");
    }
