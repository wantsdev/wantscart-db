...
import cn.techwolf.dbwolf.parser.expression.OrExpression;
import cn.techwolf.dbwolf.parser.expression.ParameterExpression;
import cn.techwolf.dbwolf.parser.function.Function;
import cn.techwolf.dbwolf.parser.function.TimeConverter;
import cn.techwolf.dbwolf.parser.statment.CommitStatment;
...
import cn.techwolf.dbwolf.parser.statment.PropertyStatment;
import cn.techwolf.dbwolf.parser.statment.RollbackStatment;
import cn.techwolf.dbwolf.parser.statment.SelectStatment;
import cn.techwolf.dbwolf.parser.statment.StartTansactionStatment;
...
import cn.techwolf.jade.datasource.SQLParseInfo;

public class MysqlParser implements /*@bgen(jjtree)*/MysqlParserTreeConstants,
        cn.techwolf.dbwolf.parser.Parser, MysqlParserConstants {/*@bgen(jjtree)*/
     ...
     */
    public static void main(String args[]) throws cn.techwolf.dbwolf.parser.ParseException {
    ...
    public Statment doParse() throws cn.techwolf.dbwolf.parser.ParseException {
        try {
            ...
            throw new cn.techwolf.dbwolf.parser.ParseException(e);
        }
    }
