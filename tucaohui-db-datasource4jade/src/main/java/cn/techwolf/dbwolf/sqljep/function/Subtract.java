...
import static cn.techwolf.dbwolf.sqljep.function.Add.DATE_ADDITION;
import static cn.techwolf.dbwolf.sqljep.function.Add.DAY_MILIS;
import static cn.techwolf.dbwolf.sqljep.function.Add.toDay;
...
public final class Subtract extends PostfixCommand {
    ...
    public static Comparable<?> sub(Comparable<?> param1, Comparable<?> param2)
        ...
        if (param1 instanceof Number && param2 instanceof Number) {
            ...
            throw new ParseException(WRONG_TYPE + "  (" + param1.getClass() + "-"
                    + param2.getClass() + ")");
        }
    }
