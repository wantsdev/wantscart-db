...
public final class OracleNumberFormat extends Format {
    ...
    private static class FORMAT {
        ...
        public boolean equals(Comparable<?> obj) {
            ...
            return (sci == other.sci && localGroups == other.localGroups
                    && numbers.equals(other.numbers) && digits == other.digits
                    && firstNine == other.firstNine && sign == other.sign && fm == other.fm
                    && b == other.b && cur == other.cur && v == other.v && dot == other.dot);
        }
    };
