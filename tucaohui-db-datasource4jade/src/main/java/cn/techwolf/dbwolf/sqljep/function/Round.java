...
import static cn.techwolf.dbwolf.sqljep.function.Trunc.DATE_EXCEPTION;
import static cn.techwolf.dbwolf.sqljep.function.Trunc.FORMAT_EXCEPTION;
import static cn.techwolf.dbwolf.sqljep.function.Trunc.TIME_EXCEPTION;
...
public class Round extends PostfixCommand {
    ...
    public static Comparable<?> round(Comparable<?> param1, Comparable<?> param2, Calendar cal)
        ...
        if (param1 instanceof Number) {
            ...
            throw new ParseException(WRONG_TYPE + " round(" + param1.getClass() + ","
                    + param2.getClass() + ")");
            ...
            if (param2 instanceof String) {
                ...
                if (s.equalsIgnoreCase("CC") || s.equalsIgnoreCase("SCC")) {
                    ...
                    cal.set(year1 + 1, 0, 1);
                    return new Timestamp(cal.getTimeInMillis());
                } else if (s.equalsIgnoreCase("SYYYY") || s.equalsIgnoreCase("YYYY")
                        || s.equalsIgnoreCase("YYY") || s.equalsIgnoreCase("Y")
                    ...
                    cal.set(year, 0, 1);
                    return new Timestamp(cal.getTimeInMillis());
                } else if (s.equalsIgnoreCase("IYYY") || s.equalsIgnoreCase("IY")
                    ...
                    throw new ParseException(NOT_IMPLIMENTED_EXCEPTION);
                } else if (s.equalsIgnoreCase("DAY") || s.equalsIgnoreCase("DY")
                    ...
                    cal.set(year, month, day - delta);
                    return new Timestamp(cal.getTimeInMillis());
                } else if (s.equalsIgnoreCase("HH") || s.equalsIgnoreCase("HH12")
        ...
        throw new ParseException(WRONG_TYPE + " trunc(" + param1.getClass() + ","
                + param2.getClass() + ")");
    }
