...
public final class OracleTimeFormat extends OracleTimestampFormat {
    ...
    protected OracleTimeFormat(ArrayList<Object> format, Calendar calendar,
            DateFormatSymbols dateSymb) {
        this.format = format;
        this.cal = calendar;
        this.symb = dateSymb;
    }
    ...
    public OracleTimeFormat(String pattern, Calendar calendar, DateFormatSymbols dateSymb)
