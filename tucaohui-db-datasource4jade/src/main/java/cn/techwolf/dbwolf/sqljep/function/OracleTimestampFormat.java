...
public class OracleTimestampFormat extends Format {
    ...
    public static abstract class DATE {
        ...
        abstract public void parse(Calendar cal, DateFormatSymbols symb, String source,
                ParsePosition pos) throws java.text.ParseException;
    ...
    public static final class fBC extends DATE {
        ...
        public StringBuffer toString(StringBuffer str, Calendar cal, DateFormatSymbols symb)
                throws java.text.ParseException {
        ...
        public void parse(Calendar cal, DateFormatSymbols symb, String source, ParsePosition pos)
                throws java.text.ParseException {
            String[] eras = symb.getEras();
    ...
    public static final class RM extends DATE {
        ...
        private final static String rmonths[] = { "I", "II", "III", "IV", "V", "VI", "VII", "VIII",
                "IX", "X", "XI", "XII", "XIII" };
    ...
    @SuppressWarnings("unchecked")
    public OracleTimestampFormat(String pattern, Calendar calendar, DateFormatSymbols dateSymb)
            throws java.text.ParseException {
        cal = calendar;
        symb = dateSymb;
        format = formatsCache.get(pattern);
    ...
    protected static void compilePattern(ArrayList<Object> format, ArrayList<DATE> symbols,
        ...
        for (int i = 0; i < plen;) {
            ...
            for (DATE d : symbols) {
                ...
                if (i + symb.length() <= plen
                        && pattern.regionMatches(true, i, symb, 0, symb.length())) {
                    if (fill.length() > 0) {
