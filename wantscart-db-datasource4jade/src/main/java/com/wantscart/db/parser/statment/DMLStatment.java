 ...
 * </pre>
 */
package com.wantscart.db.parser.statment;

import com.wantscart.db.parser.dbobject.Column;
import com.wantscart.db.parser.dbobject.Table;
import com.wantscart.db.parser.expression.AndExpression;
...
import com.wantscart.db.sqljep.function.ComparativeAND;
import com.wantscart.db.sqljep.function.ComparativeBaseList;
import com.wantscart.db.sqljep.function.ComparativeOR;
...
public abstract class DMLStatment extends AbstractStatment {
    ...
    private static Logger logger = LoggerFactory.getLogger(DMLStatment.class);
    ...
    protected static void evaluateExpression(Expression expression,
            Map<Table, Map<Column, Comparative>> tablesMap, Object[] parameters) {
        if (expression instanceof BaseExpressionList) {
            ...
            columnMap.put(colExpression.getColumn(),
                    (Comparative) colExpression.evaluate(parameters));
        }
    }

    protected static void evaluateExpression(BaseExpressionList elist,
            Map<Table, Map<Column, Comparative>> tablesMap, Object[] parameters) {
        boolean and = false;
