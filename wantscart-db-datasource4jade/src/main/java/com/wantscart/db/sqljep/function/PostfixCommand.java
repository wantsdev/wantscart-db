...
public abstract class PostfixCommand implements PostfixCommandI {
     ...
     * for evaluating the function. This includes popping off the
     * parameters from the stack, and pushing the result back on the stack.
     */
    abstract public Comparable<?>[] evaluate(ASTFunNode node, JepRuntime runtime)
