...
/**
 * Like algorithm. It supports two variants of syntax. The first is SQL
 * syntax. The second is JRE regexp syntax. By default SQL syntax is used.
 * To use regexp syntax put pattern into slashes. For example "/^10*.?/"
 */
