...
public class MonthName extends PostfixCommand {
    ...
    public static String monthName(Comparable<?> param, Calendar cal, DateFormatSymbols symb)
    ...
    public Comparable<?> getResult(Comparable<?>... comparables) throws ParseException {
        return monthName(comparables[0], JepRuntime.getCalendar(),
                JepRuntime.getDateFormatSymbols());
    }
}
