...
public final class OracleDateFormat extends OracleTimestampFormat {
    ...
    protected OracleDateFormat(ArrayList<Object> format, Calendar calendar,
    ...
    public OracleDateFormat(String pattern, Calendar calendar, DateFormatSymbols dateSymb)
