...
public class PlaceholderDbWolfConfig extends DbWolfConfig {
    ...
    /* (non-Javadoc)
     * @see cn.techwolf.dbwolf.client.config.DbWolfConfig#getEndpoints()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.techwolf.dbwolf.client.config.DbWolfConfig#getDsFactoryClz()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.techwolf.dbwolf.client.config.DbWolfConfig#getZkRoot()
     */
    @Override
