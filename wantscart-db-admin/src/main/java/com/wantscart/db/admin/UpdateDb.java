...
import com.wantscart.db.xml.*;
import com.wantscart.db.zookeeper.DataSerializer;
import com.wantscart.db.zookeeper.ZKClient;
import com.wantscart.db.zookeeper.exception.ZKDataSerializeException;
import com.wantscart.db.zookeeper.exception.ZKKeeperException;
...
public final class UpdateDb extends StormCommand {
    ...
    private class UpdateTask implements StormTask, Comparable<UpdateTask> {
        ...
        private boolean isRouter(DbInstanceConfig newConfig) {
            return newConfig.getType() == DbXmlParser.DbInstanceType.CDbInstanceRouter;
        }
        ...
        public int cacuPriority(DbXmlParser.DbInstanceType type) {
            if (type == DbXmlParser.DbInstanceType.CDbInstanceSingler) {
                return 1;
            }
            return 2;
        }
